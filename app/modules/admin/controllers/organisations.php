 ...
 *
 */
class Controller_Admin_Organisations extends Ecl_Mvc_Controller {
	...
	public function beforeAction() {
		...
		$this->router()->layout()->addBreadcrumb('Organisations', $this->router()->makeAbsoluteUri('/admin/organisations/index/'));
	...
	public function actionEdit() {
		...
		$this->view()->render('organisations_edit');
	}// /method
	...
	public function actionIndex() {
		$this->view()->organisations = $this->model('organisationstore')->findAll();
		$this->view()->render('organisations_index');
	}// /method
