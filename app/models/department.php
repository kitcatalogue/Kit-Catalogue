...
class Department {
	...
	public $item_count_internal = 0;    // The number of internally-restricted items in this department
	public $item_count_public = 0;      // The number of public items in this department
