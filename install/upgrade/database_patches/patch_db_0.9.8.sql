...
-- 
-- Definition of table `homepageblock`
--
...
--
-- Alter building table to have latitude and longditude
-- 
ALTER TABLE `building`
  ADD COLUMN `latitude` VARCHAR(15),
...
ALTER TABLE `tag` ADD UNIQUE `tag`(`tag`);
...
UPDATE `system_info` SET value='0.9.8' WHERE name='database_version';
